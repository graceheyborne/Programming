...
print('QUESTION 3.1')
def spaced(influenza_genome):
    for i in range(10):
        index = i * 25
        print(influenza_genome[index])
spaced_output = spaced(influenza_genome)
...
print('QUESTION 3.2')
def spaced_again(influenza_genome):
    new_list = []
    for i in range(20):
        index = i * 5
        new_list.append(influenza_genome[index])
        print(influenza_genome[index])
    return new_list
spaced_again_output = spaced_again(influenza_genome)
...
print('QUESTION 3.3')
def every_other(spaced_again_output):
    for i in range(10):
        index = i * 2
        print(spaced_again_output[index])   
every_other_output = every_other(spaced_again_output)
# 4 Putting it all together: write a function that implements the code from problem 1.4, then implements the code from problem 2.3.
print('QUESTION 4')
def put_it_together(influenza_genome):
    for i in range(200, 300):
        if i % 3 == 0 and i % 5 == 0:
                influenza_genome[i] = 10
    for i in range(234, 238):
        if i == 236:
            ...
            print(influenza_genome[i])       
put_it_together_output = put_it_together(influenza_genome)
